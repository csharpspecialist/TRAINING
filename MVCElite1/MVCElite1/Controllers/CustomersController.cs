...
using MVCElite1.Data;

namespace MVCElite1.Controllers
{
    public class CustomersController : Controller
    {
        ...
        //[HttpPost]
        //public ActionResult List(Company company)
        //{
        //    Company comp = new Company();
        //    return View(comp);
        //}
        ...
        public ActionResult List(string searchBy, string search)
        {
            ...
            {
                return View(db.Database.Where(x => x.LastName.StartsWith(search) || search == null).ToList());
            }
