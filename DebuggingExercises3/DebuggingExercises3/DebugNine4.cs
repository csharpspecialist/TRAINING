...
// The price of a license is $25 if the boat motor is 50 HP or under
  ...
  public static void NineFour()
   {
      ...
      BoatLicense[] license = new BoatLicense[3];//add 3
      int x;
...
class BoatLicense
{
      ...
      public int MotorSizeInHP
      {
         get
         {
            return motorSizeInHP;//spelled correctly
         }
         set
         {
            motorSizeInHP = value;
